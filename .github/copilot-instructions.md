...
> - Code Style: [`.clinerules/04-Code-style-guidelines.md`](../.clinerules/04-Code-style-guidelines.md)
...
**ALWAYS:**
- Use 4-space indentation and place opening braces on a **new line**
- Check **return values**, not error variables, for error handling
- Add or update unit tests for every behavior change or bug fix
- Follow the code style in `.clinerules/04-Code-style-guidelines.md`
...
**Code Style Rules:** `.clinerules/04-Code-style-guidelines.md`
